...
```json
{
  "extends": "@avivox/typescript-config/nextjs.json"
}
```
...
```bash
npm install --save-dev @avivox/typescript-config
```

Or with pnpm:

```bash
pnpm add -D @avivox/typescript-config
```
...
```json
{
  "extends": "@avivox/typescript-config/react.json"
}
```
...
// tsconfig.json
{
  "extends": "@avivox/typescript-config/node.json",
  "compilerOptions": {
    "outDir": "dist"
  },
  "include": ["src/**/*"],
...
// tsconfig.json
{
  "extends": "@avivox/typescript-config/native.json",
  "include": ["**/*.ts", "**/*.tsx"],
...
```json
{
  "extends": "@avivox/typescript-config/base.json",
  "compilerOptions": {
    "target": "es2018",
